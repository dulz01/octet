...
namespace octet {
  ...
  public:
    ...
    void app_init() {
      ...
      btRigidBody *rb_left_ground = left_ground->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(-8, 0, 0);
      mesh_instance *plank1 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank1 = plank1->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(-6, 0, 0);
      mesh_instance *plank2 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank2 = plank2->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(-4, 0, 0);
      mesh_instance *plank3 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank3 = plank3->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(-2, 0, 0);
      mesh_instance *plank4 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank4 = plank4->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(0, 0, 0);
      mesh_instance *plank5 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank5 = plank5->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(2, 0, 0);
      mesh_instance *plank6 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank6 = plank6->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(4, 0, 0);
      mesh_instance *plank7 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank7 = plank7->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(6, 0, 0);
      mesh_instance *plank8 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      btRigidBody *rb_plank8 = plank8->get_node()->get_rigid_body();

      mat.loadIdentity();
      mat.translate(8, 0, 0);
      mesh_instance *plank9 = app_scene->add_shape(mat, new mesh_box(vec3(0.1f, 0.1f, 20), 1), green, true);
      ...
      btRigidBody *rb_right_ground = right_ground->get_node()->get_rigid_body();
      
      btTransform tran1 = btTransform::getIdentity();
      tran1.setOrigin(btVector3(0.1, 0, 0));

      btTransform tran2 = btTransform::getIdentity();
      tran2.setOrigin(btVector3(-0.1, 0, 0));
