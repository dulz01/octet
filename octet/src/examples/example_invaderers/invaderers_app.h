...
namespace octet {
  ...
  public:
    ...
    void app_init() {
      ...
      sprites[ship_sprite].init(ship, 0, -2.75f, 0.25f, 0.25f, 1, 1);
      ...
      sprites[paused_sprite].init(Paused, 20, 0, 3, 1.5f, 1, 1);
      ...
      for (int j = 0; j != num_rows; ++j) {
        for (int i = 0; i != num_cols; ++i) {
          ...
          sprites[first_invaderer_sprite + i + j*num_cols].init(
            invaderer, ((float)i - num_cols * 0.5f) * 0.5f, 2.50f - ((float)j * 0.5f), 0.25f, 0.25f, 1, 1
          );
        }
      }
      ...
      sprites[first_border_sprite + 0].init(white, 0, -3, 6, 0.2f, 1, 1);
      sprites[first_border_sprite + 1].init(white, 0, 3, 6, 0.2f, 1, 1);
      sprites[first_border_sprite + 2].init(white, -3, 0, 0.2f, 6, 1, 1);
      sprites[first_border_sprite + 3].init(white, 3, 0, 0.2f, 6, 1, 1);
